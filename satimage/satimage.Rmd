...
Analizzando le coordinate per i singoli attributi si riesce a capire che le variabili sovrapposte corrispondono tutte alla stessa lunghezza d’onda (Red, Green NIR1, NIR2)
...
Evidenzia la misura di similarita' tra i cluster e le classi del dataset, al variare del parametro k
