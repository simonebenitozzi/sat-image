...
sprintf("Best SVM parameters were gamma: %3.0f cost: %3.0f", svm.tuning$best.parameters$gamma, svm.tuning$best.parameters$cost)
...
colnames(validationset.multiroc) = c('red_soil_true', 'cotton_crop_true', 'grey_soil_true', 'damp_grey_soil_true', 'vegetation_true', 'very_damp grey_soil_true',
